...
export const MOTHERBOARDS: readonly Motherboard[] = [
  ...
  /* ──────────────────────────────────────────────────────────────────────
   * Other brands. ESC details aggregated from public teardowns
   * (electricscooterguide, ESG forum, Reddit r/ElectricScooters,
   * scootertalk.org, manufacturer service docs). MCU values are
   * best-effort; some flagship boards conceal MCU markings.
   * ────────────────────────────────────────────────────────────────────── */

  // Inokim
  {
    id: "mb-inokim-quick4",
    displayName: "Inokim Quick 4 mainboard",
    shortLabel: "Quick 4",
    family: "inokim",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-inokim-ox",
    displayName: "Inokim OX / OXO mainboard",
    shortLabel: "OX",
    family: "inokim",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["inokim-ox", "inokim-oxo"],
    confidence: "community",
    notes: "OXO uses two of these boards in master/slave for dual-motor.",
  },
  {
    id: "mb-inokim-light2",
    displayName: "Inokim Light 2 / Mini 2 mainboard",
    shortLabel: "Light 2",
    family: "inokim",
    drvMcu: "stm32f1",
    bleMcu: "nrf51",
  ...
  // Dualtron / Minimotors — Korean. Use Minimotors EY3 controllers.
  {
    id: "mb-dualtron-thunder",
    displayName: "Minimotors Dualtron Thunder ESC (EY3)",
    shortLabel: "Thunder EY3",
    family: "dualtron",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    motorPowerW: 5400,
    ...
    compatibleScooterIds: ["dualtron-thunder", "dualtron-thunder-2"],
    confidence: "documented",
    notes: "Twin EY3 controllers (master/slave). Pairs with Minimotors EY3 app.",
  },
  {
    id: "mb-dualtron-x2",
    displayName: "Minimotors Dualtron X / X2 / Storm ESC (EY4)",
    shortLabel: "X2 EY4",
    family: "dualtron",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["dualtron-x", "dualtron-x2", "dualtron-storm"],
    confidence: "documented",
    notes: "Latest-gen EY4 controllers with regen and throttle curve presets.",
  },
  {
    id: "mb-dualtron-mini",
    displayName: "Dualtron Mini ESC",
    shortLabel: "Mini",
    family: "dualtron",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-speedway-mini4",
    displayName: "Minimotors Speedway Mini 4 Pro ESC",
    shortLabel: "SW Mini 4",
    family: "speedway",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    motorPowerW: 500,
  ...
  {
    id: "mb-kaabo-mantis",
    displayName: "Kaabo Mantis Pro ESC",
    shortLabel: "Mantis Pro",
    family: "kaabo",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    motorPowerW: 1600,
    ...
    compatibleScooterIds: ["kaabo-mantis-pro", "kaabo-mantis-8", "kaabo-mantis-10"],
    confidence: "documented",
    notes: "Pairs with the EY3 / Mantis Tuning apps for parameter editing.",
  },
  {
    id: "mb-kaabo-wolf-warrior",
    displayName: "Kaabo Wolf Warrior 11 ESC",
    shortLabel: "Wolf 11",
    family: "kaabo",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-kaabo-skywalker",
    displayName: "Kaabo Skywalker 10S ESC",
    shortLabel: "Skywalker",
    family: "kaabo",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
    motorPowerW: 800,
  ...
  // Apollo
  {
    id: "mb-apollo-city-2023",
    displayName: "Apollo City 2023 mainboard (Apollo Smartkey)",
    shortLabel: "City'23",
    family: "apollo",
    drvMcu: "stm32g4",
    bleMcu: "esp32",
    ...
    compatibleScooterIds: ["apollo-city-2023", "apollo-city-pro-2023"],
    confidence: "documented",
    notes: "Pairs via the Apollo app over BLE; ESP32 enables OTA + telemetry.",
  },
  {
    id: "mb-apollo-phantom",
    displayName: "Apollo Phantom V3 mainboard",
    shortLabel: "Phantom V3",
    family: "apollo",
    drvMcu: "stm32g4",
    bleMcu: "esp32",
    motorPowerW: 2400,
  ...
  {
    id: "mb-apollo-pro-2023",
    displayName: "Apollo Pro 2023 mainboard",
    shortLabel: "Pro'23",
    family: "apollo",
    drvMcu: "stm32g4",
    bleMcu: "esp32",
    ...
    compatibleScooterIds: ["apollo-pro-2023"],
    confidence: "documented",
    notes: "MagBrake regen + Smart Pilot ABS firmware features.",
  },
  {
    id: "mb-apollo-air",
    displayName: "Apollo Air / Ghost mainboard",
    shortLabel: "Air",
    family: "apollo",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-unagi-voyager",
    displayName: "Unagi Voyager mainboard",
    shortLabel: "Voyager",
    family: "unagi",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["unagi-voyager", "unagi-model-one-e500"],
    confidence: "community",
    notes: "Dual-motor; smart helmet-light + Unagi GPS subscription firmware.",
  },

  // Bird / Lime
  {
    id: "mb-bird-air",
    displayName: "Bird Air / One mainboard (Okai-derived)",
    shortLabel: "Bird",
    family: "bird",
    drvMcu: "stm32f1",
    bleMcu: "nrf51",
    ...
    compatibleScooterIds: ["bird-air", "bird-one"],
    confidence: "community",
    notes: "Bird One is an Okai ES200 derivative; consumer firmware locks SIM.",
  },
  {
    id: "mb-lime-gen4",
    displayName: "Lime Gen 4 mainboard",
    shortLabel: "Lime G4",
    family: "lime",
    drvMcu: "stm32l4",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["lime-gen4"],
    confidence: "inferred",
    notes: "Fleet hardware with cellular IoT module; reference only.",
  },

  // Razor / EcoSmart
  {
    id: "mb-razor-e300",
    displayName: "Razor E300 controller",
    shortLabel: "E300",
    family: "razor",
    drvMcu: "stm32f0",
    bleMcu: "unknown",
    ...
    compatibleScooterIds: ["razor-e300", "razor-e200"],
    confidence: "documented",
    notes: "Pre-BLE generation — no smartphone pairing.",
  },
  {
    id: "mb-razor-ecosmart-metro",
    displayName: "Razor EcoSmart Metro HD controller",
    shortLabel: "EcoSmart",
    family: "razor",
    drvMcu: "stm32f1",
    bleMcu: "nrf51",
  ...
  {
    id: "mb-gotrax-gxl",
    displayName: "Gotrax GXL V2 / XR Elite mainboard",
    shortLabel: "GXL V2",
    family: "gotrax",
    drvMcu: "stm32f0",
    bleMcu: "nrf51",
  ...
  {
    id: "mb-gotrax-g4",
    displayName: "Gotrax G4 / G6 mainboard",
    shortLabel: "G4",
    family: "gotrax",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["gotrax-g4", "gotrax-g6"],
    confidence: "documented",
    notes: "Pairs with the Gotrax app; OTA over BLE.",
  },

  // Hiboy
  {
    id: "mb-hiboy-s2",
    displayName: "Hiboy S2 / S2 Pro / Max mainboard",
    shortLabel: "S2",
    family: "hiboy",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-hiboy-titan",
    displayName: "Hiboy Titan Pro mainboard",
    shortLabel: "Titan Pro",
    family: "hiboy",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    motorPowerW: 800,
  ...
  {
    id: "mb-turboant-x7",
    displayName: "Turboant X7 Pro / V8 mainboard",
    shortLabel: "X7 Pro",
    family: "turboant",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
  ...
  // Nanrobot
  {
    id: "mb-nanrobot-d6plus",
    displayName: "Nanrobot D6+ / LS7 mainboard",
    shortLabel: "D6+",
    family: "nanrobot",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["nanrobot-d6-plus", "nanrobot-ls7"],
    confidence: "community",
    notes: "Dual-motor 1000 W × 2 with shared throttle.",
  },
  {
    id: "mb-nanrobot-rs11",
    displayName: "Nanrobot RS11 mainboard",
    shortLabel: "RS11",
    family: "nanrobot",
    drvMcu: "stm32f4",
    bleMcu: "esp32",
  ...
  // VSETT
  {
    ...
    compatibleScooterIds: ["vsett-9-plus"],
    confidence: "documented",
    notes: "EY3-app compatible; firmware-tuned variant of the Mantis ESC.",
  },
  {
    id: "mb-vsett-10plus",
    displayName: "VSETT 10+ / 11+ mainboard",
    shortLabel: "VSETT 10+",
    family: "vsett",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-zero-10x",
    displayName: "Zero 10X mainboard (Ecorider)",
    shortLabel: "10X",
    family: "zero",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["zero-10x"],
    confidence: "documented",
    notes: "Ecorider OEM platform; widely modded for higher phase current.",
  },
  {
    id: "mb-zero-11x",
    displayName: "Zero 11X mainboard",
    shortLabel: "11X",
    family: "zero",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-zero-9",
    displayName: "Zero 9 / Zero 8 mainboard",
    shortLabel: "Zero 9",
    family: "zero",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-emove-cruiser",
    displayName: "EMOVE Cruiser mainboard",
    shortLabel: "Cruiser",
    family: "emove",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["emove-cruiser"],
    confidence: "documented",
    notes: "IPX6-rated; pairs with the Voro Motors / EY3 app.",
  },
  {
    id: "mb-emove-roadrunner",
    displayName: "EMOVE RoadRunner / Touring mainboard",
    shortLabel: "RoadRun",
    family: "emove",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-fluid-mantis",
    displayName: "Fluid Mantis / Horizon mainboard",
    shortLabel: "F-Mantis",
    family: "fluidfreeride",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["fluid-mantis", "fluid-horizon"],
    confidence: "community",
    notes: "Kaabo Mantis platform; same EY3-app firmware family.",
  },

  // OKAI (large OEM behind Bird/Lime/branded retail).
  {
    id: "mb-okai-es400",
    displayName: "OKAI ES400 / ES400B mainboard",
    shortLabel: "ES400",
    family: "okai",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["okai-es400", "okai-es400b"],
    confidence: "documented",
    notes: "Used as OEM base for Bird One and several rebadges.",
  },
  {
    id: "mb-okai-neon",
    displayName: "OKAI Neon / Beetle mainboard",
    shortLabel: "Neon",
    family: "okai",
    drvMcu: "stm32f0",
    bleMcu: "nrf51",
  ...
  {
    id: "mb-joyor-s8",
    displayName: "Joyor S8 / S10 mainboard",
    shortLabel: "S8",
    family: "joyor",
    drvMcu: "gd32f3",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-iscooter-i9",
    displayName: "iScooter i9 / i9 Pro / i10 mainboard",
    shortLabel: "i9",
    family: "iscooter",
    drvMcu: "gd32f3",
    bleMcu: "nrf51",
    ...
    compatibleScooterIds: ["iscooter-i9", "iscooter-i9-pro", "iscooter-i10"],
    confidence: "community",
    notes: "Aliexpress mass-market; M365-style GATT, often non-stock DRV.",
  },

  // Pure
  {
    id: "mb-pure-air-pro",
    displayName: "Pure Air Pro mainboard",
    shortLabel: "Air Pro",
    family: "pure",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-pure-advance",
    displayName: "Pure Advance / Advance Flex mainboard",
    shortLabel: "Advance",
    family: "pure",
    drvMcu: "stm32g4",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-niu-kqi3",
    displayName: "NIU KQi3 Pro / Sport mainboard",
    shortLabel: "KQi3",
    family: "augment",
    drvMcu: "stm32g4",
    bleMcu: "nrf52",
    ...
    compatibleScooterIds: ["niu-kqi3-pro", "niu-kqi3-sport"],
    confidence: "documented",
    notes: "Proprietary BLE protocol — not Ninebot-compatible despite shape.",
  },
  {
    id: "mb-niu-kqi-air",
    displayName: "NIU KQi Air / KQi2 Pro mainboard",
    shortLabel: "KQi Air",
    family: "augment",
    drvMcu: "stm32g4",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-yadea-ks5",
    displayName: "Yadea KS5 / KS5 Pro mainboard",
    shortLabel: "KS5",
    family: "yadea",
    drvMcu: "gd32f3",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-yadea-ks6",
    displayName: "Yadea KS6 Pro / ElitePrime mainboard",
    shortLabel: "KS6",
    family: "yadea",
    drvMcu: "stm32g4",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-atomi-alpha",
    displayName: "Atomi Alpha / X mainboard",
    shortLabel: "Alpha",
    family: "atomi",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-levy-plus",
    displayName: "Levy Plus / Original mainboard",
    shortLabel: "Levy",
    family: "levy",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-evolv-pro-r",
    displayName: "EVOLV Pro-R / Tour mainboard",
    shortLabel: "Pro-R",
    family: "evolv",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
  ...
  // Egret / Currus / Varla / Yume / CityBlitz / Wegoboard
  {
    id: "mb-egret-ten",
    displayName: "Egret Ten V4 / Pro mainboard",
    shortLabel: "Egret Ten",
    family: "egret",
    drvMcu: "stm32f1",
    bleMcu: "nrf52",
    motorPowerW: 600,
  ...
  {
    id: "mb-currus-nf10",
    displayName: "Currus NF10 / Panther mainboard",
    shortLabel: "NF10",
    family: "currus",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
  ...
  {
    id: "mb-varla-eagle-one",
    displayName: "Varla Eagle One / Pegasus mainboard",
    shortLabel: "Eagle One",
    family: "varla",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    motorPowerW: 1600,
    ...
    compatibleScooterIds: ["varla-eagle-one", "varla-pegasus"],
    confidence: "community",
    notes: "Dual 1000 W motors; LCD with bottom-button settings.",
  },
  {
    id: "mb-yume-x11",
    displayName: "Yume X11 / Y10 / X13 mainboard",
    shortLabel: "X11",
    family: "yume",
    drvMcu: "stm32f4",
    bleMcu: "esp32",
  ...
  {
    id: "mb-cityblitz-cb064",
    displayName: "CityBlitz CB064 / CB016 mainboard",
    shortLabel: "CB064",
    family: "cityblitz",
    drvMcu: "gd32f3",
    bleMcu: "nrf51",
  ...
  {
    id: "mb-wegoboard-suprem3",
    displayName: "Wegoboard Suprem 3.0 / Slash 1700 mainboard",
    shortLabel: "Suprem 3.0",
    family: "wegoboard",
    drvMcu: "stm32f4",
    bleMcu: "nrf52",
    motorPowerW: 1000,
